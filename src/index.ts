...
app.get('/api/health', cors({origin: 'https://example.com', optionsSuccessStatus: 200}), (req:express.Request, res:express.Response) => {
  res.json('hi !!')
})

app.get('/api/domEvent/index', cors({origin: 'https://example.com', optionsSuccessStatus: 200}), (req:express.Request, res:express.Response) => {
